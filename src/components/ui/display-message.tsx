...
const sizeStyles = {
  hero: {
    ...
    bar: "top-[-1px] left-[5px] h-[78px] w-[415px] max-w-[calc(100%-5px)] max-[768px]:!h-[3rem] max-[768px]:top-[15px] max-[768px]:left-1",
    text: "text-[64px] md:text-[110px] md:leading-[90px] max-[768px]:leading-[87px]",
  },
  section: {
    container: "w-auto max-w-none",
    bar: "top-[-1px] left-[6px] h-[80px] md:h-[114px] max-[768px]:!top-[0px] max-[577px]:!top-[-1px] max-[577px]:!h-[49px] max-[577px]:!left-[.3rem]",
