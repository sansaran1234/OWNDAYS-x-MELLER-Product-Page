      ...
      <div className="relative mt-6 lg:mt-10">
        <div className="relative z-20 flex flex-col gap-0 px-5 max-[575px]:px-0 lg:px-[70px]">
          <DisplayMessage
            ...
            size="section"
            align="left"
            barClassName="max-md:top-[34px] max-md:left-[5px] max-md:h-[4.7rem] max-md:w-[282px] lg:w-[422px] max-[992px]:!w-[420px] max-[768px]:!w-[280px]"
            reveal
          />
          ...
          <DisplayMessage
            ...
            size="section"
            align="left"
            barClassName="w-[654px] max-[992px]!:w-[656px] max-[768px]:!w-[431px] max-[768px]:!h-[4.7rem] max-[768px]:!top-[34px]"
            reveal
            revealDelay={0.12}
          />
        </div>
